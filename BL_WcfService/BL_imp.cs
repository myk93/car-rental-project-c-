...
namespace BL_WcfService
{
    ...
    public class BL_imp : IBL
    {
        ...
        public void createListOfFault()
        {
            ...
            ad.city = name_of_city[rand.Next(2)];
            ad.street = name_of_street[rand.Next(6)];
            try
            {
                add_Fault(new Fault((fault_type)rand.Next(15), (who_fault)rand.Next(2), 0, rand.Next(100, 1550), "musach"));
            }
            catch (Exception e)
            {
        ...
        public void createListOfCar()
        {
            ...
            ct.Manufacturer = name_of_car[rand.Next(7)];
            ct.model = model[rand.Next(15)];
        ...
        public void createListOfClient()//catgor,mispar_rishion,tokf
        {
            ...
            ad.building = rand.Next(1, 97);
            ad.city = name_of_city[rand.Next(3)];
            ad.street = name_of_street[rand.Next(7)];
